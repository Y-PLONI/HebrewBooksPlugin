...
את המהדורות המקבילות ומציגה לחצן מפוצל אחד: לחיצה על הלחצן פותחת את מהדורת
ברירת המחדל, והחץ שלצידו פותח תפריט עם כל המהדורות. החישוב והפתיחה
דקלרטיביים ואינם מפעילים את ה־WebView של התוסף.
