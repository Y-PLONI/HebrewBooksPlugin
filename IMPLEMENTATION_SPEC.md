...
| `anyWord` | `א or ב` |
| `mostWords` / `atLeast` | דיסיונקציה של צירופי k מילים: `(א w/30 ב) or ...`, ובטווח `sameSection` `(א and ב) or ...` |
...
היחידה היחידה שגדולה מהחלון; פירוק "לפחות k מתוך n" נעצר ב-`maximumMatchCombinations`
(32 צירופים), ומעליו נשלחת דיסיונקציה פשוטה שמחזירה גם ספרים עם מילה אחת — המיון לפי
מספר המופעים משאיר את העשירים בראש, כמו הדירוג של אוצריא במצבים האלה.
